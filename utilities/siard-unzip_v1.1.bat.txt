...
java -jar %_zip64root%%_zip64path% x -d=%_unzipfolder% %_siardfolder%%_siardfile%

REM Outputs conole log to external file next to the SIARD-file
REM java -jar %_zip64root%%_zip64path% x -d=%_unzipfolder% %_siardfolder%%_siardfile% > %_siardfolder%%_siardfile%.log
