...
REM versjon: 2018-12-12
REM

REM marker vekk exit med REM foran før kjøring
exit

set _foldername=katalognavn

REM innhold kataloger
REM dir %_foldername% /s /on > innhold-katalog_%_foldername%.txt

REM innhold liste
dir %_foldername% /s /b > innhold-liste_%_foldername%.txt
